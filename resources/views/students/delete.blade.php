...
@section("content")
<form action="{{route("deletingData",$student->id)}}" method="post">
    @method("DELETE")
    @csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="name" name="name" value="{{$student->name}}" required readonly>
  </div>
    
  <div class="mb-3">
    <label for="score" class="form-label">Score</label>
    <input type="text" class="form-control" id="score" name="score" value="{{$student->score}}" required readonly>
  </div>
  <div class="mb-3">
